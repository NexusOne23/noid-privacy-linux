#!/usr/bin/env bats
#
# Test that VPN candidate-name matching references the canonical global regex,
# while the semantic classifier decides whether a candidate is actually VPN.
#
# Bug class: inconsistent regex globals (NoID Privacy Bug Pattern #5).
