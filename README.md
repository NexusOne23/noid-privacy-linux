...
[![Version](https://img.shields.io/badge/version-3.2.4-green.svg)](https://github.com/NexusOne23/noid-privacy-linux/releases)
...
$ sudo bash noid-privacy-linux.sh --ai
  ...
  NoID Privacy for Linux v3.2.4 — Privacy & Security Audit for Linux Desktops
